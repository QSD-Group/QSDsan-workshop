...
Part of this module is based on the DMsan repository:
https://github.com/QSD-Group/DMsan
...
class MCDA:
    ...
    '''
    def __init__(self,  alt_names, indicator_scores,
                 indicator_weights=None, criterion_weights=None):
        ...
        self.indicator_weights = indicator_weights or pd.DataFrame({
                'Econ': 1,
                'Env': 1,
                }, index=[0])
        self.criterion_weights = criterion_weights or pd.DataFrame({
            'Ratio': '1:1',
            'Econ': 1,
            'Env': 1,
            'Description': 'Econ, Env',
            }, index=[0])
    ...
    @property
    def alt_names(self):
        '''[Iterable(str)] Names of the alternatives under consideration.'''
